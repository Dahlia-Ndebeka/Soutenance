...
@Component({
  selector: 'app-ajoutermoduleges',
  templateUrl: './ajoutermoduleges.component.html',
  styleUrls: ['./ajoutermoduleges.component.scss']
})
export class AjoutermodulegesComponent implements OnInit {
