...
export class FormationService {
  ...
  refreshListeAd(): Observable<Formation[]> {
    return this.httpClient.get<Formation[]>(this.apiServer + '/listeformationAd.php')
    .pipe(
      catchError(this.errorHandler)
    )
  }
  
  refreshListeGes(): Observable<Formation[]> {
    return this.httpClient.get<Formation[]>(this.apiServer + '/listeformationGes.php')
    .pipe(
      catchError(this.errorHandler)
    )
  }
  
  refreshListeTech(): Observable<Formation[]> {
    return this.httpClient.get<Formation[]>(this.apiServer + '/listeformationTech.php')
    .pipe(
      catchError(this.errorHandler)
    )
  }
