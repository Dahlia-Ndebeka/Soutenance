...
@Component({
  selector: 'app-ajoutsujetad',
  templateUrl: './ajoutsujetad.component.html',
  styleUrls: ['./ajoutsujetad.component.scss']
})
export class AjoutsujetadComponent implements OnInit {
